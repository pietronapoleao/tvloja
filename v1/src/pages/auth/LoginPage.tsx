  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (result.requiresVerification) {
        navigate('/auth/verify-otp', { state: { email: result.email } });
      } else {
        navigate('/dashboard');
      }
    } catch (err: unknown) {
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center space-x-2">
              ...
              <div className="text-left">
                <span className="text-2xl font-bold text-gray-900">TV</span>
                <span className="text-2xl font-bold text-indigo-600">Loja</span>
                <p className="text-xs text-gray-500 -mt-1">SaaS · sites profissionais</p>
              </div>
            </Link>
          </div>
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Acesse sua conta para gerenciar seu site e assinatura
            </p>
          </div>
          ...
          <button
            ...
            className="w-full mb-6 p-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl font-semibold flex items-center justify-center gap-2 hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg shadow-indigo-500/25"
          >
            <Zap className="w-5 h-5" />
            Entrar como Demo (Acesso Rápido)
          </button>
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-indigo-600 to-purple-700 items-center justify-center p-12">
        <div className="max-w-lg text-center text-white">
          ...
          <p className="text-lg text-indigo-100">
            Crie, personalize e publique seu e-commerce com facilidade. 
